...
For further information about the variables you can check [here] (https://archive.ics.uci.edu/ml/datasets/Student+Performance):
...
We can make different logistic regression models and see their performance, looking at the training at testing errors. In the following models we have started with 6 explanatory variables, and every next model we erase the less significant variable.
